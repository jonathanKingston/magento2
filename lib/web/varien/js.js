...
Varien.searchForm.prototype = {
    initialize: function (form, field, emptyText) {
        ...
        jQuery(this.form).on('submit', this.submit.bind(this));
        jQuery(this.field).on('focus', this.focus.bind(this));
        jQuery(this.field).on('blur', this.blur.bind(this));
        this.blur();
    },
...
Varien.FileElement.prototype = {
    initialize: function (id) {
        ...
        jQuery(this.fileElement).on('change', this.selectFile.bind(this));
    },
