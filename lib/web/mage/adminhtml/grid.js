        ...
        initGrid: function () {
            ...
            if ($(this.containerId + this.tableSufix)) {
                ...
                for (row = 0; row < this.rows.length; row++) {
                    ...
                    jQuery(this.rows[row]).on('mouseover', this.trOnMouseOver);
                    jQuery(this.rows[row]).on('mouseout', this.trOnMouseOut);
                    jQuery(this.rows[row]).on('click', this.trOnClick);
                    jQuery(this.rows[row]).on('dblclick', this.trOnDblClick);
                }
            }
